...
<h1 class="subH1">
	...
	<div class="copy">工場業務部へのお問い合わせ<em>Contact US</em></div>
</h1>
<div class="container contactContet">
    <div class="breadcrumbs"><div class="container"><a href="/">TOP</a> > <a href="/contact/">お問い合わせ</a> > 工場業務部へのお問い合わせ</div></div>
    <div id="pageContents" class="col-xs-12 col-sm-12 col-md-12">
		<div class="contactIndex">
            ...
            <div id="contactBlock">
                <?php echo do_shortcode('[mwform_formkey key="315"]'); ?>
	        </div>
    </div>
</div>
</section>
