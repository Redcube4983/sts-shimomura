...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-K9K1V7QV08"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-K9K1V7QV08');
</script>
<?php wp_head(); ?>
</head>
...
<body id="pageTop" class="animsition">
	<div id="loadingLayer">
		<div id="box">
			<p class="loading-text" style="display: none;" >Across The World<br><span>SHIMOMURA</span></p>
		</div>
	</div>
				...
				<ul class="gnav__list">
					...
					<li class="gnav__list__inner">
						...
						<ul class="gnav__child">
							...
							<li class="gnav__child__inner"><a href="/products/pbfreesus/">切削加工の常識を変える鋼</a></li>
