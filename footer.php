...
<footer class="l-footer">
    <p id="page-top"><a href="#pageTop"><img src="<?php echo get_template_directory_uri(); ?>/common/images/page_up.png" class="img-responsive center-block"></a></p>
        <nav class="l-footer__nav">
			...
			<div class="l-footer__nav-block">
				<div class="l-footer__nav-title-area">
					<a class="l-footer__nav-title l-footer__nav-title-parent c-icon__arrow--white" href="/products/">製品紹介</a>
					<span class="c-btn__arrow l-footer__nav-title-arrow"></span>
				</div>
				<ul class="l-footer__nav-list">
					...
					<li class="c-icon__arrow--accent"><a href="/products/brand/">各種取扱い鋼種と各法規制</a></li>
